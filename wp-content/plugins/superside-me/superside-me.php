...
if ( ! defined( 'SUPERSIDEME_VERSION' ) ) {
	define( 'SUPERSIDEME_VERSION', '2.8.1' );
}
...
function superside_me_require() {
	$files = array(
		'class-supersideme',
		'class-supersideme-getter',
		'settings/class-supersideme-definesettings',
		'settings/class-supersideme-getsetting',
		'class-supersideme-builder',
		'class-supersideme-cron',
		'class-supersideme-css',
		'settings/class-supersideme-customizer',
		'class-supersideme-enqueue',
		'settings/class-supersideme-helper',
		'settings/class-supersideme-helptabs',
		'settings/class-supersideme-licensing',
		'settings/class-supersideme-settings',
		'helper-functions',
	);
