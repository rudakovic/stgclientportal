...
SureFeedback Admin Site is a WordPress plugin that lets you get approval and feedback for all your design projects.
...
Check out the [Documentation](https://surefeedback.com/docs/) for detailed information!

== Changelog ==

= Version 4.9.0 – 04th June, 2025 =
- New: Added a new Widget Control feature to choose where the comment widget appears.Easily enable it on specific pages for better control over who can comment and where.
- New: Added a new 'Request Changes' feature with support for requesting feedback from multiple users through email.
- Improvement: Optimized the performance of comment loading on client-facing pages.
- Fix: Addressed and resolved all issues affecting email delivery functionality.
- Fix: Resolve the issue where the Private Comment feature does not work for added project members.

= Version 4.8.3 - 29th April, 2025 =
- Improvement: Optimized WPML filters to ensure comments are correctly included in REST responses with proper language context.
- Improvement: Enhanced capabilities and logic handling in REST API calls.
- Fix: Resolved issue where the Page URL edit icon was not displaying on the Overview section.
- Fix: Resolved the edit, trash, and icon features that were not working properly on dashboard pages.
- Fix: Resolved text domain loading issue for compatibility with WordPress 6.8.

= Version 4.8.2 - 16th April, 2025 =
- Improvement: Added compatibility to WordPress version 6.8.
- Improvement: Improved the "Reset" functionality for better reliability and user experience.
- Fix: Resolved Reset Password Layout and Email String Conversion Problems
- Fix: Fixed bugs in file upload functionality.

= Version 4.8.1 - 9th April, 2025 =
- Improvement: Added compatibility to PHP Version upto 8.2.
- Improvement: Updated Freemius SDK to version 2.11.0.
- Fix: Improved event handling to prevent potential issues with browser DevTools.

= Version 4.8.0 - 29th January, 2025 =
- New: Added NPS Survey to gather your valuable feedback for SureFeedback.
- Improvement: Updated Freemius SDK to version 2.10.1.
- Fix: Changing a Website or Page URL pencil icon is not visible.

= Version 4.7.7 - 12th December, 2024 =
- Fix: Hide comment toolbar in the Bricks builder editor.

= Version 4.7.6 - 8th October, 2024 =
- Fix: PHP Notice on system status page.

= Version 4.7.5 - 30th September 2024 =
- New: Added SureTriggers integration to automate tasks and connect with over hundreds of apps. Easily manage feedback workflows without coding using SureTriggers integration in SureFeedback.
- Improvement: Updated Freemius SDK to version 2.8.1.

= Version 4.7.4 - 30th April, 2024 =
- Improvement: Added compatibility to WordPress version 6.5.
- Improvement: Updated Freemius SDK to version 2.6.2.
- Fix: PHP Warning on System Status page.
- Fix: Undefined user role issue on network site.

= Version 4.7.3 - 1st January, 2024 =
- Fix: Console error while adding a comment when BuddyPress plugin is active on site.
- Fix: Project members text overflow issue.
- Fix: Unable to change comment status when current site is deleted from websites list.

= Version 4.7.2 - 9th November, 2023 =
- Improvement: Updated Freemius SDK to version 2.6.1.
- Fix: Hide help menu and chat icon.
- Fix: Comment toolbar visibility issue on mobile devices.

= Version 4.7.1 - 14th December, 2023 =
- Improvement: Updated Freemius SDK to version 2.6.0.

= Version 4.7.0 - 7th November, 2023 =
- New: Changed ProjectHuddle plugin name as SureFeedback.

= Version 4.6.3 - 4th September, 2023 =
- Improvement: Updated help beacon.

= Version 4.6.2 - 23rd August, 2023 =
- Improvement: Added compatibility to WordPress version 6.3.

= Version 4.6.1 - 7th August, 2023 =
- Fix: Plugin automatic update issue.

= Version 4.6.0 - 3rd August, 2023 =
- New: Integrated PDF Mockups & File Uploads Addons.
- Improvement: Added a new option to ignore query parameters in URL.
- Fix: Console error on system status page.
- Fix: Layout breaks on reset password modal on mockup projects.
...
- **New Feature** Added Slack integration with different actions support like a new comment added on a project, a project is approved/unapproved etc. [More Info](https://surefeedback.com/docs/how-to-integrate-surefeedback-with-slack/)
