...
class PH_Logger_List_Table extends PH_List_Table {
	...
	var $total_items; // Declare total_items property
    var $custom_query_string; // Declare custom_query_string property
    var $_column_headers; // Declare _column_headers property
