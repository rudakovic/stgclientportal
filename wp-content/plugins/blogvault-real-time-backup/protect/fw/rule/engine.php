...
if (!class_exists('BVProtectFWRuleEngine_V602')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V602 {
	use BVProtectFWRuleStringFunc_V602;
	use BVProtectFWRuleArrayFunc_V602;
	use BVProtectFWRuleMiscFunc_V602;
	use BVProtectFWRuleRequestFunc_V602;
	use BVProtectFWRuleWPFunc_V602;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V602::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V602 $e) {
			$this->error = $e;
		}
	}
