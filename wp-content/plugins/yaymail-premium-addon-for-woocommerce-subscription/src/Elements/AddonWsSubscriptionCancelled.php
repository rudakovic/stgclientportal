 ...
 */
class AddonWsSubscriptionCancelled extends BaseElement {

    use SingletonTrait;

    protected static $type = 'addon_ws_subscription_cancelled';
    ...
    public static function get_data( $attributes = [] ) {
        ...
        return [
            'id'              => uniqid(),
            'type'            => self::$type,
            'name'            => __( 'Subscription Cancelled', 'yaymail' ),
            'icon'            => self::$icon,
            ...
            'data'            => [
                ...
                'end_prepaid_title' => ElementsHelper::get_text_input(
                    $attributes,
                    [
                        'value_path'    => 'end_prepaid_title',
                        'title'         => __( 'End of Prepaid Term title', 'yaymail' ),
                        'default_value' => __( 'End of Prepaid Term', 'woocommerce' ),
                    ]
                ),
                ...
                'rich_text'         => [
                    ...
                    'default_value' => '[yaymail_wc_subscription_cancelled]',
                    'type'          => 'content',
                ],
            ],
        ];
    ...
    public static function get_layout( $element, $args ) {
        $path = 'src/templates/elements/subscription-cancelled.php';
