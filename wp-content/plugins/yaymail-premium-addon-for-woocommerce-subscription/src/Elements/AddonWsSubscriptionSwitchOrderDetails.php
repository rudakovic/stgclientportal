...
/**
 * Subscription Switch Order Details
 */
class AddonWsSubscriptionSwitchOrderDetails extends BaseElement {

    use SingletonTrait;

    protected static $type = 'addon_ws_subscription_switch_order_details';
    ...
    public static function get_data( $attributes = [] ) {
        ...
        return [
            'id'              => uniqid(),
            'type'            => self::$type,
            'name'            => __( 'Subscription Switch Order Details', 'yaymail' ),
            'icon'            => self::$icon,
            ...
            'data'            => [
                ...
                'rich_text'            => [
                    ...
                    'default_value' => '[yaymail_wc_subscription_switch_order_details]',
                    'type'          => 'content',
                ],
                'title'                => [
                    'value_path'    => 'title',
                    ...
                    'default_value' => isset( $attributes['title'] ) ? $attributes['title'] : '<span style="font-weight: 600; font-size: 20px;">Subscription #[yaymail_wc_subscription_id]</span>',
                    'type'          => 'content',
                ],
                'product_title'        => [
    ...
    public static function get_layout( $element, $args ) {
        $path = 'src/templates/elements/subscription-switch-order-details.php';
