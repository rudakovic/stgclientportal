 ...
 */
class AddonENRSubscriptionTrialEndDetails extends BaseElement {

    use SingletonTrait;

    protected static $type = 'addon_enr_subscription_trial_end_details';
    ...
    public static function get_data( $attributes = [] ) {
        ...
        return [
            'id'              => uniqid(),
            'type'            => self::$type,
            'name'            => __( 'Subscription Trial End Details', 'yaymail' ),
            'icon'            => self::$icon,
            ...
            'data'            => [
                ...
                'trial_end_date_title' => ElementsHelper::get_text_input(
                    $attributes,
                    [
                        'value_path'    => 'trial_end_date_title',
                        'title'         => __( 'Trial End Date title', 'yaymail' ),
                        'default_value' => __( 'Trial End Date', 'woocommerce' ),
                    ]
                ),
                ...
                'rich_text'            => [
                    ...
                    'default_value' => '[yaymail_enr_subscription_trial_end_details]',
                    'type'          => 'content',
                ],
            ],
        ];
    ...
    public static function get_layout( $element, $args ) {
        $path = 'src/templates/elements/subscription-trial-end-details.php';
