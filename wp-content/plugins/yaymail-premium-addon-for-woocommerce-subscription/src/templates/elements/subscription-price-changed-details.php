...
if ( ! empty( $subscription ) || $is_sample ) {
    ob_start();
    ?>
    <h2 class="yaymail-enr-subscription-price-changed-details__title" style="<?php echo esc_attr( $table_title_style ); ?>" > <?php echo wp_kses_post( do_shortcode( $data['main_title'] ) ); ?> </h2>
    <?php
