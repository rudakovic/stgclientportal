...
/**
 * WcEmailCompletedRenewalOrder Class
 *
 * @method static WcEmailCompletedRenewalOrder get_instance()
 */
class WcEmailCompletedRenewalOrder extends BaseEmail {
    ...
    protected function __construct() {
        ...
        $email            = $emails['WCS_Email_Completed_Renewal_Order'];
        $this->id         = $email->id;
    ...
    public function get_default_elements() {
        $email_title = __( 'Your renewal order is complete', 'woocommerce-subscriptions' );
        // translators: customer name.
        $email_text  = sprintf( esc_html__( 'Hi %s,', 'woocommerce' ), '[yaymail_billing_first_name] [yaymail_billing_last_name]' );
        $email_text .= '<br><br>' . esc_html__( 'We have finished processing your subscription renewal order:', 'woocommerce-subscriptions' );
    ...
    public function get_template_path() {
        return YAYMAIL_ADDON_WS_PLUGIN_PATH . 'src/templates/emails/wc-email-customer-completed-renewal-order.php';
    }
}
