...
/**
 * @method: static WcSubscriptionSuspendedRenderer get_instance()
 */
class WcSubscriptionSuspendedRenderer {
    ...
    public function initialize_titles() {
            $this->titles = [
                ...
                'date_suspended' => $this->element_data['date_suspended_title'] ?? TemplateHelpers::get_content_as_placeholder( 'date_suspended_title', esc_html__( 'Date Suspended', 'yaymail' ), $this->is_placeholder ),
            ];
    }
    ...
    public function render() {
        ...
        ?>
        <table class="yaymail-ws-subscription-suspended td" cellspacing="0" cellpadding="6" style="<?php echo esc_attr( $table_style ); ?>" border="1" width="100%">
            ...
            <thead>
                <tr>
                    ...
                    <th class="td date-suspended-title" scope="col" style="<?php echo esc_attr( $style ); ?>"><?php echo esc_html( $this->titles['date_suspended'] ); ?></th>
                </tr>
            </thead>
            ...
            <tbody>
                    <?php
                        ...
                        $subscription_date_suspended = $is_using_sample ? $this->sample_subscription['date_suspended'] : date_i18n( wc_date_format(), $this->subscription->get_time( 'end', 'site' ) );
                    ?>
                <tr>
                    ...
                    <td class="td date-suspended-row" scope="row" style="<?php echo esc_attr( $style ); ?>">
                        <?php echo esc_html( $subscription_date_suspended ); ?>
                    </td>
                </tr>
            </tbody>
        </table>
