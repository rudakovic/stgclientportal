...
class Sliced_Pdf {
	 ...
	 * @since   1.0.0
	 */
	public static function init_pdf( $id = 0, $html = '', $file = '', $mode = 'I', $debug = false ) {
		
		require_once( SLICED_INVOICES_PDF_PATH . 'vendor/sliced-pdf/sliced-pdf.php' );
	 ...
	 * @since   1.0.0
	 */
	public static function set_watermark( $id = 0, $mpdf = null ) {
